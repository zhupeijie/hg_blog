...
<head>
    ...
    <title>仪表台</title>
    <meta name="keywords" content="仪表台">
    <meta name="description" content="仪表台">

    <link rel="shortcut icon" href="/favicon.ico">
    <link href="/admin/css/bootstrap.min.css" rel="stylesheet">
    <link href="/admin/css/font-awesome.min93e3.css" rel="stylesheet">
                ...
                <div class="ibox-content">
                    ...
                    <div class="m-t-md">
                        <small class="pull-right">
                            <i class="fa fa-clock-o"> </i> 最后更新：2014.11.11
                        </small>
                        <small>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li>
                                <a href="index_3.html#">选项1</a>
                            </li>
                            <li>
                                <a href="index_3.html#">选项2</a>
                            </li>
                        </ul>
                        <a class="close-link">
                ...
                <div class="ibox-content">
                    <div>
                        ...
                        <h4>广东地区的数据报告 <br/>
                            <small class="m-r">
                                <a href="graph_flot.html"> 获取最新股票价格</a>
                            </small>
                        </h4>
                    </div>
                </div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content no-padding">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <p>
                                <a class="text-info" href="index_3.html#">@星探子</a>
                                我的目标就是想做一个跟你一样有责任感，有思想，有深度的新闻媒体从业人
                            </p>
                            <small class="block text-muted"><i class="fa fa-clock-o"></i> 1分钟前</small>
                        </li>
                        <li class="list-group-item">
                            <p>
                                <a class="text-info" href="index_3.html#">@小七是</a>
                                其实自己一半的大学生活也基本上是和新闻为伍了～一篇小小的稿子也许只有5、6百字，可以却可以写1、2个小时。一场会议也许3个小时，睡一觉就过去了，可是却要端着相机站3个小时，害怕错过一个经典的镜头。新闻人，更辛苦。
                            </p>
                        ...
                        <li class="list-group-item">
                            <p>
                                <a class="text-info" href="index_3.html#">@镜子mini</a>
                                大一邵老师说记者是高危职业，防火防盗防记者；大二时老师说嫁人莫嫁记者郎。可他们依然坚守岗位，培养新闻学子。现在大三，毕业了也会从事新闻工作。有时候坚持一件事情，并不是因为这样做了会改变什么，而是坚信，这样做是对的。
                            </p>
                            <small class="block text-muted"><i class="fa fa-clock-o"></i> 2分钟前</small>
                        </li>
                        <li class="list-group-item ">
                            <p>
                                <a class="text-info" href="index_3.html#">@爱nimen</a>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content timeline">
                    ...
                    <div class="timeline-item">
                        <div class="row">
                            <div class="col-xs-3 date">
                                <i class="fa fa-briefcase"></i> 6:00 <br>
                    ...
                    <div class="timeline-item">
                        <div class="row">
                            <div class="col-xs-3 date">
                                <i class="fa fa-file-text"></i> 7:00 <br>
                    ...
                    <div class="timeline-item">
                        <div class="row">
                            ...
                            <div class="col-xs-7 content">
                                ...
                                <p>
                                    喝了4杯水，上了3次厕所，控制台输出出2324个错误，神啊，带我走吧 </p>
                            </div>
                        </div>
                    </div>
                    <div class="timeline-item">
                        <div class="row">
                            <div class="col-xs-3 date">
                                <i class="fa fa-phone"></i> 11:00 <br>
                    ...
                    <div class="timeline-item">
                        <div class="row">
                            <div class="col-xs-3 date">
                                <i class="fa fa-user-md"></i> 09:00 <br>
                                <small>21小时前</small>
                            </div>
                            <div class="col-xs-7 content">
                    ...
                    <div class="timeline-item">
                        <div class="row">
                            <div class="col-xs-3 date">
                                <i class="fa fa-comments"></i> 12:50 <br>
...
<script>
    $(document).ready(function () {
        ...
        var d1 = [[1262304000000, 1], [1264982400000, 100], [1267401600000, 1], [1270080000000, 200], [1272672000000, 1], [1275350400000, 100], [1277942400000, 1], [1280620800000, 300]];
        var d2 = [[1262304000000, 100], [1264982400000, 1], [1267401600000, 150], [1270080000000, 1], [1272672000000, 230], [1275350400000, 1], [1277942400000, 150], [1280620800000, 10]];
        var data3 = [{label: "Data 1", data: d1, color: "#23c6c8"}, {label: "Data 2", data: d2, color: "#1ab394"}];
